...
// clang-format off
enum LAYERS { _BASE, _SYMBOL, _ARROW, _RGB };
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
         ...
         KC_SCLN,    KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,                              KC_Y,    KC_U,    KC_I,    KC_O,    KC_P, KC_MINS,
    ...
    [_SYMBOL] = LAYOUT(
      ...
      S(KC_SCLN), KC_EXLM,   KC_AT, KC_HASH,  KC_DLR, KC_PERC,                           KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN,  KC_F12,
